...
<head>
  ...
  <title>Nasabah - Sistem Informasi Keuangan</title>
  ...
  <div class="wrapper">
    ...
    <header class="main-header">
      <a href="index.php" class="logo">
        ...
        <span class="logo-lg"><img src="../assets/trash.png" style="max-width:20%;"> <b> Abankku</b></span>
      </a>
          ...
          <ul class="nav navbar-nav">
            ...
            <li class="dropdown user user-menu">
              <a href="user.php" class="dropdown-toggle" data-toggle="dropdown">
                ...
                if($profil['user_foto'] == ""){ 
                  ?>
                  <img src="../gambar/user/pp.png" class="user-image">
                <?php }else{ ?>
      ...
      <section class="sidebar">
        <div class="user-panel">
          ...
          <div class="pull-left info">
            ...
            <a href="user.php"><i class="fa fa-circle text-success"></i> Online</a>
          </div>
        </div>
